...
{
    public class CreateResponse : IRecord, IComparable
    {
        private static ILog log = LogManager.GetLogger(typeof(CreateResponse));
        ...
        {
            CreateResponse peer = (CreateResponse)obj;
            if (peer == null)
            {
