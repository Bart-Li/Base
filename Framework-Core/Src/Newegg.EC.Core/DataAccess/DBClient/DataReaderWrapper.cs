...
namespace Newegg.EC.Core.DataAccess.DBClient
{
    /// <summary>
    ...
    /// management.
    /// </summary>
    internal abstract class DataReaderWrapper : MarshalByRefObject, IDataReader
    {
        /// <summary>
        /// Inner data reader.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref='DataReaderWrapper'/> class that delegates all methods
        ...
        /// <summary>
        /// Gets the actual raw <see cref="IDataReader"/> we're wrapping.
        /// </summary>
        ...
        {
            get { return this.innerReader[name]; }
        }
