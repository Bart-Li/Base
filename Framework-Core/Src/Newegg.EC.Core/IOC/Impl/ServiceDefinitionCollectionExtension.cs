...
namespace Newegg.EC.Core.IOC.Impl
{
    public static class ServiceDefinitionCollectionExtension
    {
        ...
        /// <param name="lifeTime">Service life time.</param>
        public static IServiceDefinitionCollection RegisterService<TServiceType>(this IServiceDefinitionCollection services, Func<IServiceProvider, object> factory, ServiceLifeTime lifeTime)
        {
        ...
        /// <param name="factory">Implement factory.</param>
        /// <param name="lifeTime">Service life time.</param>
        public static IServiceDefinitionCollection RegisterService(this IServiceDefinitionCollection services, Type serviceType, Func<IServiceProvider, object> factory, ServiceLifeTime lifeTime)
        {
            if (serviceType == null)
            {
                throw new ArgumentNullException("Service type is null.");
        ...
        private static IServiceDefinition CreateServiceDefine(Type serviceType, object implementInstance, Type implementType, Func<IServiceProvider, object> implementFactory, ServiceLifeTime lifeTime)
        {
