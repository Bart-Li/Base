...
using Newegg.EC.Core.IOC.Impl;
using Newegg.EC.Core.Reflection;
...
namespace Newegg.EC.Core.IOC
{
    ...
    public static class ServiceRepository
    {
        ...
        public static IServiceDefinitionCollection BuildServiceDefinitionCollection()
        {
            ...
            if (definitions.Any())
            {
                definitions.ForEach(serviceDefinition => 
                {
        ...
        private static IEnumerable<IServiceDefinition> GetServicesDefinition()
        {
            ...
            var serviceGroup = services.SelectMany(service => service.GetCustomAttributes<AutoSetupServiceAttribute>().Select(attr => new { Attr = attr, Impl = service }))
        ...
        private static bool ContainsAutoSetupServiceAttribute(Type type)
        {
            ...
            return type.GetCustomAttribute<AutoSetupServiceAttribute>() != null;
        }
    }
}
